      ...
      <footer className="footer">
        <div className="footer-container">
          <div className="social-media">
            <div className="sm">
              <a
                href="https://www.instagram.com/tienda_depelitos/"
                target="_blank"
              ...
              <a
                href="https://www.facebook.com/tiendadepelitos/"
                target="_blank"
                rel="noopener noreferrer"
              >
              ...
              <a
                href="https://api.whatsapp.com/send?phone=56949271828&fbclid=IwAR139qF9jChqBu-QlUWQvkh-GZOYt4f5DjnMv-yBx5SCXIY2ZP7Tt0x434k"
                target="_blank"
                rel="noopener noreferrer"
              >
